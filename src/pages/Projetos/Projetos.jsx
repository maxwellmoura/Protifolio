                ...
                <div className="container-projetos">
                    <div className="projeto">
                        <a href="https://maxwellmoura.github.io/cursodev/Sindicato/">
                            <img src="./src/assets/sindicato.PNG" alt="Site" />
                            <h1>Projeto 1</h1>
                    ...
                    <div className="projeto">
                        <a href="https://maxwellmoura.github.io/cursodev/LandingPage/">
                            <img src="./src/assets/landpage.PNG" alt="LandingPage" />
                            <h1>Projeto 2</h1>
                            <div className="informacoes-projeto">
                                <h2>LandingPage</h2>
                                <p>Projeto feito usando HTML e CSS</p>
                    ...
                    <div className="projeto">
                        <a href="https://maxwellmoura.github.io/cursodev/rock/">
                            <img src="./src/assets/rock.PNG" alt="Seach de Bandas" />
                            <h1>Projeto 3</h1>
                            <div className="informacoes-projeto">
                    ...
                    <div className="projeto">
                        <a href="https://maxwellmoura.github.io/cursodev/agencia/">
                            <img src="./src/assets/agencia.PNG" alt="Agencia de Viagem" />
                            <h1>Projeto 4</h1>
                            <div className="informacoes-projeto">
                    ...
                    <div className="projeto">
                        <a href="https://mini-blog-seven-xi.vercel.app/">
                            <img src="./src/assets/miniblog.PNG" alt="MiniBlog" />
                            <h1>Projeto 5</h1>
                            <div className="informacoes-projeto">
                                <h2>MiniBlog</h2>
